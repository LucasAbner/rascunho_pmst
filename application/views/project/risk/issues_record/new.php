						...
						<div class="panel-body">
							...
							<form action="<?= base_url() ?>integration/issue-log/insert/" method="post">
								...
								<div class="form-group col-lg-12">
									...
									<textarea class="form-control" id="identification" name="identification" ></textarea>
								</div>
								...
								<label><?= $this->lang->line('ir-identification_date') ?></label>
									...
									<div>
										<input id="identification_date"  type="date" name="identification_date" class="form-control input-md">
									</div>
								</div>
								...
								<label><?= $this->lang->line('ir-resolution_date') ?></label>
									<!-- <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('date-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a> -->
									<div>
										<input  type="date" name="resolution_date"  class="form-control input-md">
									</div>
								</div>
								...
								<label><?= $this->lang->line('ir-replan_date') ?></label>
									<!-- <a class="btn-sm btn-default" data-toggle="tooltip" data-placement="right" title="<?= $this->lang->line('date-tp') ?>"><i class="glyphicon glyphicon-comment"></i></a> -->
									<div>
										<input  type="date" name="replan_date"  class="form-control input-md">
									</div>
								</div>
								...
								<div class="form-group col-lg-6">
									...
									<textarea class="form-control" id="responsable" name="responsable" ></textarea>
								</div>
								...
								<div class="form-group col-lg-6">
									...
									<textarea class="form-control" id="situation" name="situation" ></textarea>
								</div>
